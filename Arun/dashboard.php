    ...
    <div class="bg-green-50 flex-1 mx-auto p-7 w-full md:pl-71 ">
        ...
        <div class="grid grid-rows lg:grid-cols-4 gap-5 mt-10">
            ...
            <div class="w-full bg-green-200 rounded-xl mx-auto p-6 space-y-2 shadow-md hover:scale-105 hover:shadow-xl">
                ...
                <div class="text-green-900 text-xl font-bold"><h1>Community Fourm</h1></div>
        ...
        <div class="bg-green-200 mt-10 p-8 rounded-xl space-y-4 shadow-xl relative">
            <h1 class="text-green-900 text-2xl font-bold">Community Fourm</h1>
            ...
            <div class="absolute text-green-800 hover:text-green-900 right-10 font-semibold">
